...
! Version       : 1.0.0
! ==============================================================================
subroutine hybrid_sort_real8_2d_direct_desc(arr)
  ! ============================================================================
  implicit none
  ...
  do while(top > 0_8)
    ...
    if(high - low < THRESHOLD)then
      call insertion_sort_real8_2d_direct_desc(arr, low, high)
      cycle
    end if
...
! Version       : 1.0.0
! ==============================================================================
subroutine insertion_sort_real8_2d_direct_desc(arr, low, high)
  ! ============================================================================
  implicit none
  ! --- Input Data -------------------------------------------------------------
  real(8),    intent(inout) :: arr(:, :)
