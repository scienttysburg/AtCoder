! ==============================================================================
! Subroutine    : hybrid_sort_int8_2d_direct_desc (f90)
! ------------------------------------------------------------------------------
! Description   : Hybrid Sort (Iterative Quicksort + Insertion Sort)
!               : Direct swap, integer(8), 2D array, descending order
...
! Version       : 1.1.0
! ==============================================================================
subroutine hybrid_sort_int8_2d_direct_desc(arr, ord)
  ! ============================================================================
  implicit none
  ...
  do while(top > 0_8)
    ...
    if(high - low < THRESHOLD)then
      call insertion_sort_int8_2d_direct_desc(arr, low, high, ord_used)
      cycle
    end if
...
end subroutine hybrid_sort_int8_2d_direct_desc
...
! ==============================================================================
! Subroutine    : insertion_sort_int8_2d_direct_desc (f90)
! ------------------------------------------------------------------------------
...
! Version       : 1.1.0
! ==============================================================================
subroutine insertion_sort_int8_2d_direct_desc(arr, low, high, ord)
  ! ============================================================================
  implicit none
  ! --- Input Data -------------------------------------------------------------
  integer(8), intent(inout) :: arr(:, :)
...
end subroutine insertion_sort_int8_2d_direct_desc