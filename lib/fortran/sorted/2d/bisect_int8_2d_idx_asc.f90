! ==============================================================================
! Function      : bisect_left_int8_2d_idx_asc (f90)
! ------------------------------------------------------------------------------
! Description   : Binary search (bisect left), integer(8), 2D array, ascending order
...
! Version       : 1.0.0
! ==============================================================================
function bisect_left_int8_2d_idx_asc(arr, idx, x, lo, hi, ord) result(pos)
  ! ============================================================================
  implicit none
  ! --- Input Data -------------------------------------------------------------
  ...
  do while(left < right)
    mid = (left + right) / 2_8
    if(row_cmp_int8_2d(arr(idx(mid), :), x, ord_used) < 0_8)then
      left  = mid + 1_8
    else
      right = mid
    end if
...
end function bisect_left_int8_2d_idx_asc

! ==============================================================================
! Function      : bisect_right_int8_2d_idx_asc (f90)
! ------------------------------------------------------------------------------
! Description   : Binary search (bisect right), integer(8), 2D array, ascending order
!               : Index-based (indirect) search; arr is unchanged
...
! Version       : 1.0.0
! ==============================================================================
function bisect_right_int8_2d_idx_asc(arr, idx, x, lo, hi, ord) result(pos)
  ! ============================================================================
  implicit none
  ! --- Input Data -------------------------------------------------------------
  integer(8), intent(in)           :: arr(:, :)
...
end function bisect_right_int8_2d_idx_asc
